...
| Norway | Experimental replay-first frontend | Public Lovtidend XML supports archive-first replay, typed receipts, and current-Lovdata consistency verification for source-complete post-2001 laws. | Commencement remains act-level, current Lovdata is one fallible editorial comparison surface, and pre-2001 history has a hard source ceiling. |
